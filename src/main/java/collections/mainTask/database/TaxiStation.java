...
public class TaxiStation {
    ...
    public List<Car> createDatabaseOfTaxiStation() {
       ...
       for (SedanCar sedanCar : sedanCarsDatabase) {
          sedanCar.areThereRoofRails();
          sedanCar.isItPossibleToTransportOversizedCargo();
          sedanCar.areTheFrontSeatsQuickFolding();
          sedanCar.isTheLuggageCompartmentSeparatedFromTheSalon();
       }
       ...
       for (WagonCar wagonCar : wagonCarsDatabase) {
          wagonCar.areThereRoofRails();
          wagonCar.isItPossibleToTransportOversizedCargo();
          wagonCar.areTheFrontSeatsQuickFolding();
          wagonCar.isTheLuggageCompartmentSeparatedFromTheSalon();
       }
       ...
       for (CoupeCar coupeCar : coupeCarsDatabase) {
          coupeCar.areThereRoofRails();
          coupeCar.isItPossibleToTransportOversizedCargo();
          coupeCar.areTheFrontSeatsQuickFolding();
          coupeCar.isTheLuggageCompartmentSeparatedFromTheSalon();
       }
